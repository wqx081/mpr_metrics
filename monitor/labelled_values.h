#ifndef MONITOR_LABELLED_VALUES_H_
#define MONITOR_LABELLED_VALUES_H_
...
class LabelledValues {
 public:
  ...
  std::map<std::vector<std::string>, Metric::TimestampedValue> CurrentValues() const;
...
#endif // MONITOR_LABELLED_VALUES_H_
